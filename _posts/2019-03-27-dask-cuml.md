...
developed at NVIDIA and mirrors the [Scikit-Learn API](https://scikit-learn.org/).
...
optimization.  With in the Dask community, [Dask-ML](https://dask-ml.readthedocs.io/en/latest/) has incrementally improved the efficiency of hyper-parameter optimization by leveraging both Scikit-Learn and dask to use multi-core and
