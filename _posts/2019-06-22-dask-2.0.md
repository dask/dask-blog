...
I'm pleased to announce the release of Dask version 2.0.  This is a major
release with bug fixes and new features.

Most major version changes of software signal many new and exciting features.
That is not the case with this release.  Instead, we decided to break many
small API points for improved maintainability, and we decided to drop support
for Python 2.

This blogpost outlines these major changes.
...
Python 2 may wish to reach out to some for-profit consulting companies, like
...
-  Cluster.workers is not a dictionary mapping worker name to worker, rather
