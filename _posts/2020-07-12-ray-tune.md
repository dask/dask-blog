...
Ray does support using their Hyperband implementation on top of technique
called Bayesian sampling. This is a modification of Hyperband that changes
hyperparameters are sampled when initializing new models. Adding this option to
Dask-ML's Hyperband implementation is future work for Dask-ML.
